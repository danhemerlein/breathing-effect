    ...
    return (
      <div className="Article color-white">
        <a href={this.props.link} target="_blank" rel="noopener noreferrer" className="block">
          ...
          <h3 className="pb1 pl1 pr1 lg:pl1 lg:pb_5 text-center lg:text-left Article__title">{this.props.title}</h3>

          <div className="flex flex-col lg:flex-row pl1 pr1 lg:pr0 lg:pl1 pb1">
